...
//        Memanggil Data Kelas
    ...
    /**
     * Metode ini dipanggil dari dalam konstruktor untuk menginisialisasi kode dibawah ini
     */
    ...
    private void initComponents() {
        ...
        stasiun_tujuan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-- Pilih Tujuan --", "Palembang (PLG)", "Kotabumi (KB)", "Muara Enim(ME)", "Baturaja(BR)" }));
        ...
        ckereta.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-- Pilih Kereta Api --", "Argo Wilis", "Argo Parahyangan", "Lodaya" }));
        ...
        stasiun_awal.setText("Tanjung Karang(TKG)");
    ...
    private void ckeretaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ckeretaActionPerformed
       ...
       if(ckereta.getSelectedItem().equals("Argo Wilis") && stasiun_tujuan.getSelectedItem().equals("Palembang (PLG)")){
            berangkat.setText("08.30 WIB");
            tiba.setText("20.19 WIB");
        }else if(ckereta.getSelectedItem().equals("Argo Wilis") && stasiun_tujuan.getSelectedItem().equals("Prabumulih (PBH)")){
            berangkat.setText("06.30 WIB");
            tiba.setText("09.45 WIB");
        }else if(ckereta.getSelectedItem().equals("Argo Wilis") && stasiun_tujuan.getSelectedItem().equals("Muaraenim (MRE)")){
            berangkat.setText("07.20 WIB");
            tiba.setText("16.15 WIB");
        }else if(ckereta.getSelectedItem().equals("Argo Wilis") && stasiun_tujuan.getSelectedItem().equals("Baturaja (BTR)")){
            berangkat.setText("06.15 WIB");
            tiba.setText("13.45 WIB");
        }else if(ckereta.getSelectedItem().equals("Argo Wilis") && stasiun_tujuan.getSelectedItem().equals("Kotabumi (KTB)")){
            berangkat.setText("09.10 WIB");
            tiba.setText("13.03 WIB");
            
            //Argo Parahyangan
        }else if(ckereta.getSelectedItem().equals("Argo Parahyangan") && stasiun_tujuan.getSelectedItem().equals("Palembang (PLG)")){
            berangkat.setText("07.30 WIB");
            tiba.setText("19.19 WIB");
        }else if(ckereta.getSelectedItem().equals("Argo Parahyangan") && stasiun_tujuan.getSelectedItem().equals("Prabumulih (PBH)")){
            berangkat.setText("08.30 WIB");
            tiba.setText("11.45 WIB");
        }else if(ckereta.getSelectedItem().equals("Argo Parahyangan") && stasiun_tujuan.getSelectedItem().equals("Muaraenim (MRE)")){
            berangkat.setText("09.20 WIB");
            tiba.setText("18.15 WIB");
        }else if(ckereta.getSelectedItem().equals("Argo Parahyangan") && stasiun_tujuan.getSelectedItem().equals("Baturaja (BTR)")){
            berangkat.setText("08.15 WIB");
            tiba.setText("15.45 WIB");
        }else if(ckereta.getSelectedItem().equals("Argo Parahyangan") && stasiun_tujuan.getSelectedItem().equals("Kotabumi (KTB)")){
            berangkat.setText("10.10 WIB");
            tiba.setText("14.03 WIB");
            
            //Lodaya
        }else if(ckereta.getSelectedItem().equals("Lodaya") && stasiun_tujuan.getSelectedItem().equals("Palembang (PLG)")){
            berangkat.setText("08.15 WIB");
            tiba.setText("20.05 WIB");
        }else if(ckereta.getSelectedItem().equals("Lodaya") && stasiun_tujuan.getSelectedItem().equals("Prabumulih (PBH)")){
            berangkat.setText("10.30 WIB");
            tiba.setText("14.45 WIB");
        }else if(ckereta.getSelectedItem().equals("Lodaya") && stasiun_tujuan.getSelectedItem().equals("Muaraenim (MRE)")){
            berangkat.setText("07.20 WIB");
            tiba.setText("14.15 WIB");
        }else if(ckereta.getSelectedItem().equals("Lodaya") && stasiun_tujuan.getSelectedItem().equals("Baturaja (BTR)")){
            berangkat.setText("07.15 WIB");
            tiba.setText("14.45 WIB");
        }else if(ckereta.getSelectedItem().equals("Lodaya") && stasiun_tujuan.getSelectedItem().equals("Kotabumi (KTB)")){
            berangkat.setText("09.10 WIB");
